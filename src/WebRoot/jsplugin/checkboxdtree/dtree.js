...
function dTree(objName, iPath, formId) {
	...
	this.icon = {
		root				: iPath+'/jsplugin/checkboxdtree/img/base.gif',
		folder			: iPath+'/jsplugin/checkboxdtree/img/folder.gif',
		folderOpen	: iPath+'/jsplugin/checkboxdtree/img/folderopen.gif',
		node				: iPath+'/jsplugin/checkboxdtree/img/page.gif',
		empty				: iPath+'/jsplugin/checkboxdtree/img/empty.gif',
		line				: iPath+'/jsplugin/checkboxdtree/img/line.gif',
		join				: iPath+'/jsplugin/checkboxdtree/img/join.gif',
		joinBottom	: iPath+'/jsplugin/checkboxdtree/img/joinbottom.gif',
		plus				: iPath+'/jsplugin/checkboxdtree/img/plus.gif',
		plusBottom	: iPath+'/jsplugin/checkboxdtree/img/plusbottom.gif',
		minus				: iPath+'/jsplugin/checkboxdtree/img/minus.gif',
		minusBottom	: iPath+'/jsplugin/checkboxdtree/img/minusbottom.gif',
		nlPlus			: iPath+'/jsplugin/checkboxdtree/img/nolines_plus.gif',
		nlMinus			: iPath+'/jsplugin/checkboxdtree/img/nolines_minus.gif'
	};
	this.parEnum = "";
	this.obj = objName;
	this.aNodes = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if(this.config.useCheckBox && nodeId!=0){
		...
		var checked = node._checked;		if(checked){
			str += '<input type="checkbox" name="id" id="c'+this.parEnum+'" onClick="caBox(\''+this.formId+'\',\'c'+this.parEnum+'\')" value="' + node.id +'" class="cx" checked />';
