		...
		<div style="width: 100%; height: 330px;" class="list_div3">
	    	<table width="100%" >
	    		<tr>
	    			...
	    			<td width="70%"><input  type="text" name="message.title"/></td>
	    		</tr>
	    		<tr>
	    			<td align="right" width="10%">接收人：</td>
	    			<td width="70%">
	    			<input id="receiverNames" name="receiverNames" type="text" size="50" readonly/>
	    			&nbsp;&nbsp;
	    		...
	    		<tr>
	    			...
	    			<td width="70%">
	    				<textarea name="message.content" rows="10" cols="60"></textarea>
	    			</td>
	    		</tr>
	    	</table>
    	</div>
